...
\begin{figure*}[h!]
    \centering
    \begin{subfigure}[t]{0.9\columnwidth} \label{subfig:ch_83}
    ...
    \end{subfigure}
    \begin{subfigure}[t]{0.9\columnwidth} \label{subfig:ch_124}
    ...
    \begin{subfigure}[t]{0.9\columnwidth} \label{subfig:ch_170}
    ...
    \end{subfigure}
    \begin{subfigure}[t]{0.9\columnwidth} \label{subfig:ch_231}
