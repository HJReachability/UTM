function simulateHighwayMerge(from_checkpoint, save_graphics, output_directory)
...
if from_checkpoint
  ...
  ID1 = 1;
  numVehicles = 3;
  p1 = popPlatoon(hw1, 0.4, hw1.speed, numVehicles, ID1);
  
  ID1 = 4;
  numVehicles = 4;
  p2 = popPlatoon(hw2, 0.4, hw1.speed, numVehicles, ID1);  
