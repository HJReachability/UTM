...
\MCnote{Added introduction to this section}Air highways exhibiting trunk routes that separate near destinations motivate the use of platoons which fly on these highways. The platooning concept provides a structural solution for monitoring and ensuring the safety of a large number of UAVs. The structure imposed by air highways reduces the number of pairwise safety checks, and makes pairwise analysis more indicative of the joint safety of all UAVs.
