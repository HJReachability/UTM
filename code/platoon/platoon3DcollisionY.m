...
data1 = shapeRectangleByCorners(g, [-d; -inf; -inf], [d; inf; inf]);
data2 = shapeRectangleByCorners(g, [-d-spacing; -inf; -inf], [d-spacing; inf; inf]);
data3 = shapeRectangleByCorners(g, [-d-2*spacing; -inf; -inf], [d-2*spacing; inf; inf]);
data4 = shapeRectangleByCorners(g, [-d-3*spacing; -inf; -inf], [d-3*spacing; inf; inf]);

data12=shapeUnion(data1,data2);
data34=shapeUnion(data3,data4);
data=shapeUnion(data12,data34);
