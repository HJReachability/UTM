...
\usepackage{cite}
\newcommand{\AEnote}{\textcolor{red}}
\newcommand{\ROnote}{\textcolor{blue}}
...
\title{Reachability-Based Safety and Liveness of Unmanned Aerial Vehicle Platoons on Air Highways}
