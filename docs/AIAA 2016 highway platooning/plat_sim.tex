...
\begin{figure}
    \centering
    \begin{subfigure}[t]{0.45\columnwidth} \label{subfig:ch_83}
        \includegraphics[width=\columnwidth]{fig/ch_83}
        \caption{A three-vehicle platoon and a four-vehicle platoon travel on their respective air highways.}
    \end{subfigure}
    \begin{subfigure}[t]{0.45\columnwidth} \label{subfig:ch_124}
        \includegraphics[width=\columnwidth]{fig/ch_124}
        \caption{The yellow vehicle begins to join the new platoon; The green vehicle becomes a leader.}
    \end{subfigure}

    \begin{subfigure}[t]{0.45\columnwidth} \label{subfig:ch_170}
        \includegraphics[width=\columnwidth]{fig/ch_170}
        \caption{The dark red vehicle joins a new platoon; the orange vehicle catches up to new platoon leader.}
    \end{subfigure}
    \begin{subfigure}[t]{0.45\columnwidth} \label{subfig:ch_231}
        \includegraphics[width=\columnwidth]{fig/ch_231}
