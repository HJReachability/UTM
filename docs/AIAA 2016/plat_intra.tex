% !TEX root = main.tex
\subsection{Reachability-Based Controllers}
...
\subsubsection{Getting to a Target State}
...
\subsubsection{Getting to a State Relative to Another Vehicle}
...
\subsubsection{Avoiding Collision}
...
THE FOLLOWING SHOULD BE IN ANOTHER SECTION
